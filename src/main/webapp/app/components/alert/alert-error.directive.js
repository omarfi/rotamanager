(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('rotamanagerApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-rotamanagerApp-error');
                var entityKey = httpResponse.headers('X-rotamanagerApp-params');
                if (errorHeader) {
